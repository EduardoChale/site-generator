...
class TestTextNode(unittest.TestCase):
    ...
    def test_not_eq_url(self):
        node = TextNode("This is a text node", TextType.BOLD,"www.test.com")
        node2 = TextNode("This is a text node", TextType.BOLD,"www.different.com")
    ...
    def test_not_eq_text(self):
        node = TextNode("This is a text node example 1", TextType.BOLD,"www.test.com")
        node2 = TextNode("This is a text node example 2", TextType.BOLD,"www.test.com")
        self.assertNotEqual(node, node2)
